    ...
    for dialog in dialogs:
        ...
        # 是Channel
            ...
            if participant_list != None:
                ...
                print("participant_list is none")
                # time.sleep(2)
            # 获取历史消息
            #print("Channel会话====获取历史消息============================")
            #message_list = await get_messages(client, entity)
...
async def main(phone, category):
    ...
    if category == 1:
        ...
        print("==============================================")
        print("=============get_contacts_info======================")
        print("==============================================")
        await get_contacts_info(client)
        print("==============================================")
        print("=============get_dialogs_info====================")
        print("==============================================")
